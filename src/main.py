...
if False:
    @vermissian.slash_command(name='roll_action', description='Rolls dice for taking an action')
    @command_logging_decorator
    @error_responder_decorator
    @character_required_decorator
...
if False:
    @vermissian.slash_command(name='roll_fallout', description='Rolls dice for a fallout check')
    @command_logging_decorator
    @error_responder_decorator
    @character_required_decorator
